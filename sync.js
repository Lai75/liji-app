...
const SYNC_KEYS = ['shiji-tasks','shiji-transactions','shiji-habits','shiji-gadgets','shiji-accounts','shiji-custom-cats','shiji-budget','shiji-category-budgets','shiji-journal','shiji-recurring','shiji-price-items'];
...
const REC_KEYS = ['shiji-tasks','shiji-transactions','shiji-habits','shiji-gadgets','shiji-accounts','shiji-recurring','shiji-price-items'];
...
async function syncNow(){
  ...
  try{
    ...
    saveSyncState();
    lastSyncAt = new Date();
    if(pulled){ await loadAll(); applyRecurring(); setTab(activeTab); }
